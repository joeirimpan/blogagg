...
def new_blog(request):
	if request.method == "POST":
		...
		if form.is_valid():
			...
			req_url = 'https://api.tumblr.com/v2/blog/'+ _blog.name +'.tumblr.com/posts/text?api_key=YOUR_API_KEY_HERE'
			...
			for post in posts:
				...
				#article.published_date = datetime.datetime.fromtimestamp(float(post['timestamp']))
